...
#SBATCH --mail-user=ho.ka@northeastern.edu
#SBATCH --ntasks=1
...
dnabin_obj<-VCF2DNAbin("$VCF_FILE",refgenome="$REF_GENOME",individual=13)
...
# Save psmc results
saveRDS(psmcr_results,file="psmcr.rds")
EOF
